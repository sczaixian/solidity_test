...
contract FundMe{
    ...
    uint256 constant TARGWT = 1000 * 10 ** 18;
    ...
    */ 
    function getFund() external payable onlyOwner windowClosed {
        require(convertEthToUsd(address(this).balance) >= TARGWT, "target is not reached");
    ...
    function refund() external windowClosed {
        require(convertEthToUsd(address(this).balance) < TARGWT, "target is reached");
